...
export default function ApologyApp() {
  ...
  const apologyPages = [
        ...
        <div className="space-y-6">
          ...
          <div className="bg-gradient-to-br from-yellow-50 via-orange-50 to-pink-50 p-6 sm:p-8 rounded-3xl border-4 border-yellow-200 shadow-xl">
            ...
            <p className="text-base sm:text-lg text-center text-gray-700 leading-relaxed mb-4">
              But I wanted to start YOUR day with something special. Something I crafted with love while you were sleeping peacefully. 😊💤
            </p>
            <div className="bg-white/70 p-4 sm:p-6 rounded-2xl mb-4">
              <p className="text-lg sm:text-xl text-center text-purple-800 font-semibold italic leading-relaxed">
                "I did this after you slept, Dipti. Every line of code, every animation, every heart... all created in the quiet hours just thinking of you." 🌙✨
              </p>
            </div>
            <div className="bg-gradient-to-r from-pink-100 to-purple-100 p-4 sm:p-6 rounded-2xl border-2 border-pink-300">
              ...
              <p className="text-sm sm:text-base text-center text-gray-700 italic">
                A lawyer learning to code just to make you smile... I think my scope is expanding in the best way possible! 💝
              </p>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-r from-blue-50 via-purple-50 to-pink-50 p-6 sm:p-8 rounded-3xl border-4 border-purple-200 shadow-xl">
            ...
            <p className="text-base sm:text-lg text-center text-gray-700 leading-relaxed mb-4">
              It's a digital love letter. A coded apology. A lawyer who learned to speak in JavaScript just to tell you: <span className="font-bold text-pink-600">I'm truly sorry, and you mean everything to me.</span> 💝
            </p>
            <div className="bg-white/70 p-4 sm:p-6 rounded-2xl border-2 border-purple-200 mt-4">
              <p className="text-base sm:text-lg text-center text-gray-800 italic leading-relaxed">
                I wish I could be female, just to truly know your emotions, to feel what you feel in that way. Hehe, my best person. <span className="font-bold text-pink-600">I miss you dherai.</span> 💕
              </p>
            </div>
            <div className="bg-gradient-to-r from-pink-100 to-red-100 p-4 sm:p-6 rounded-2xl border-2 border-pink-300 mt-4">
              <p className="text-sm sm:text-base text-center text-gray-700 italic leading-relaxed">
                "UFF Meri dil mein thodi khali si jaga thi... and that empty space? It has your name written all over it." 💝✨
              </p>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-br from-green-50 to-teal-50 p-6 rounded-3xl border-3 border-green-200 shadow-lg">
            ...
            <p className="text-center text-gray-700">
              This is interactive! You'll unlock pages, play mini-games, and collect hearts along the way! 🎮💝
            </p>
          </div>
        </div>
      )
    ...
    {
      title: "✈️ Flying Across The Ocean To Hug You!",
      icon: <div className="text-4xl sm:text-5xl">✈️</div>,
      content: (
        <div className="space-y-6">
          <div className="bg-gradient-to-r from-sky-100 to-blue-100 p-6 sm:p-8 rounded-3xl border-4 border-sky-300 shadow-2xl">
            ...
            <p className="text-base sm:text-lg text-center text-gray-700 mb-6 leading-relaxed">
              I'd hop on the first plane from New York to London, flying 3,459 miles across the Atlantic Ocean, just to wrap my arms around you and never let go! 🤗💕
            </p>
            ...
            {!showPlane ? (
              <div className="text-center space-y-4">
                <div className="bg-white/70 p-4 sm:p-6 rounded-2xl border-2 border-sky-200 mb-4">
                  <p className="text-sm sm:text-base text-gray-700 italic leading-relaxed">
                    "UFF Meri dil mein thodi khali si jaga thi... and only YOUR hug can fill it completely." 💝
                  </p>
                </div>
                <button
                ...
                >
                  <span className="relative z-10">✈️ Send Me Flying To You! ✈️</span>
                ...
                <p className="text-xs sm:text-sm text-gray-600 italic">Click to watch me cross the ocean just for you! 🌊💕</p>
              </div>
            ) : !showHugAnimation ? (
              <div className="relative">
                ...
                <div className="relative h-72 sm:h-80 md:h-96 bg-gradient-to-b from-sky-200 via-blue-200 to-blue-400 rounded-3xl overflow-hidden border-4 border-sky-400 mb-4 shadow-2xl">
                  {/* Sun */}
                  <div className="absolute top-4 right-4 text-5xl sm:text-6xl animate-spin-slow">☀️</div>
                  ...
                  <div className="absolute top-8 left-12 sm:left-20 text-3xl sm:text-4xl opacity-70 animate-float">☁️</div>
                  <div className="absolute top-16 sm:top-20 right-24 sm:right-32 text-3xl sm:text-4xl opacity-60 animate-float" style={{animationDelay: '1s'}}>☁️</div>
                  <div className="absolute top-12 sm:top-16 left-1/2 text-4xl sm:text-5xl opacity-50 animate-float" style={{animationDelay: '2s'}}>☁️</div>
                  <div className="absolute top-28 left-1/4 text-2xl sm:text-3xl opacity-40 animate-float" style={{animationDelay: '1.5s'}}>☁️</div>
                  
                  {/* Birds flying */}
                  <div className="absolute top-20 left-1/3 text-xl animate-float" style={{animationDelay: '0.5s'}}>🕊️</div>
                  <div className="absolute top-32 right-1/3 text-xl animate-float" style={{animationDelay: '1.2s'}}>🕊️</div>
                  ...
                  <div className="absolute left-[6%] sm:left-[10%] bottom-[18%] sm:bottom-[25%] text-center z-10">
                    <div className="relative">
                      ...
                      <div className="relative text-5xl sm:text-6xl mb-2 animate-bounce">🗽</div>
                      <div className="absolute -top-10 sm:-top-12 left-1/2 transform -translate-x-1/2 whitespace-nowrap">
                        ...
                        <div className="text-2xl sm:text-3xl mt-1 animate-wiggle">👋</div>
                      </div>
                  ...
                  <div className="absolute right-[6%] sm:right-[10%] top-[38%] sm:top-[45%] text-center z-10">
                    <div className="relative">
                      ...
                      <div className="relative text-5xl sm:text-6xl mb-2 animate-bounce" style={{animationDelay: '0.5s'}}>🏰</div>
                      <div className="absolute -top-10 sm:-top-12 left-1/2 transform -translate-x-1/2 whitespace-nowrap">
                        ...
                        <div className="text-2xl sm:text-3xl mt-1 animate-heartbeat">💝</div>
                      </div>
                  ...
                  >
                    <div className="relative">
                      {/* Airplane with trail */}
                      <div className="relative">
                        <div className="absolute -left-8 top-1 text-2xl sm:text-3xl opacity-30">💨</div>
                        <div className="text-6xl sm:text-7xl drop-shadow-2xl">✈️</div>
                        <div className="absolute -top-3 -right-3 text-3xl sm:text-4xl animate-wiggle drop-shadow-lg">🏃‍♂️</div>
                  ...
                  <div className="absolute top-3 sm:top-4 left-1/2 transform -translate-x-1/2 bg-white/95 px-3 sm:px-4 py-2 rounded-full shadow-xl border-2 border-sky-300 backdrop-blur-sm">
                    <p className="text-xs sm:text-sm font-bold text-gray-700 text-center">
                      🌍 {Math.round((100 - planeProgress) * 34.59)} miles to go!
                    </p>
                    <p className="text-xs text-gray-600 text-center">✈️ Altitude: {Math.round(30000 + planeProgress * 50)} ft</p>
                  </div>
                </div>
                ...
                <div className="bg-white p-4 sm:p-6 rounded-2xl border-4 border-sky-200 shadow-2xl">
                  <div className="flex items-center justify-between mb-3">
                    <span className="text-sm sm:text-base font-bold text-sky-900 flex items-center gap-2">
                      <span className="text-2xl animate-bounce">✈️</span> Flight Progress:
                    </span>
                  ...
                  <div className="h-5 sm:h-6 bg-sky-100 rounded-full overflow-hidden border-3 border-sky-300 shadow-inner">
                    ...
                    >
                      ...
                      <div className="absolute inset-0 flex items-center justify-around text-xs">
                        {planeProgress > 20 && <span>💕</span>}
                        {planeProgress > 40 && <span>💖</span>}
                        {planeProgress > 60 && <span>💗</span>}
                        {planeProgress > 80 && <span>💝</span>}
                      </div>
                    </div>
                  </div>
                  <p className="text-center mt-3 text-sm sm:text-base text-gray-600 italic font-semibold">
                    {planeProgress < 20 ? "🛫 Taking off from New York... thinking of you!" : 
                     planeProgress < 40 ? "🌊 Flying over the Atlantic Ocean! Miss you so much!" :
                     planeProgress < 60 ? "☁️ Halfway there! Can't wait to hold you!" :
                     planeProgress < 80 ? "👀 I can see the UK! Almost there, my love!" :
                     planeProgress < 95 ? "🏰 Approaching London! Get ready for the biggest hug!" :
                     "🛬 Landing... Running to you... 💕"}
                  </p>
                </div>
              </div>
            ) : (
                  ...
                  <div className="text-center">
                    {hugPhase === 0 && (
                      <div className="animate-zoomIn">
                        ...
                        <p className="text-3xl font-black text-pink-900">I LANDED! 🎉</p>
                    ...
                    {hugPhase === 1 && (
                      <div className="animate-slideIn">
                        <div className="text-8xl mb-6">
                          ...
                          <span className="inline-block animate-wiggle" style={{animationDelay: '0.2s'}}>🧍‍♀️</span>
                        </div>
                        <p className="text-3xl font-black text-purple-900">Almost there! 💕</p>
                    ...
                    {hugPhase === 2 && (
                      <div className="animate-zoomIn">
                        ...
                        <p className="text-4xl font-black text-pink-900 mb-4">*TIGHT HUG* 💝</p>
                      ...
                      <div className="animate-fadeIn">
                        <div className="relative">
                          <div className="text-9xl mb-6">
                            ...
                            <span className="absolute top-0 left-1/2 transform -translate-x-1/2 text-6xl animate-ping">💕</span>
                          </div>
                        </div>
                        ...
                        <p className="text-2xl text-purple-800 mb-6 italic">
                          "In your arms is where I belong, Dipti" 💝
                        </p>
                        ...
                        <div className="bg-white/80 p-6 rounded-2xl mb-6 border-3 border-pink-300">
                          <p className="text-lg text-gray-700 leading-relaxed">
                            ...
                            This hug would last forever. Distance can't measure what you mean to me. 🌍💕
                          </p>
                        </div>
          ...
          <div className="bg-gradient-to-r from-purple-50 to-pink-50 p-4 sm:p-6 rounded-3xl border-3 border-purple-200">
            <p className="text-base sm:text-lg text-center text-gray-700 italic leading-relaxed">
              "3,459 miles separate us, but not even an ocean can keep my heart from you. One day, this won't be an animation - it'll be real." 🌍💕✈️
            </p>
          </div>
        </div>
      )
        ...
        <div className="space-y-6">
          <div className="bg-gradient-to-r from-pink-100 via-purple-100 to-pink-100 p-6 sm:p-8 rounded-3xl border-4 border-pink-300 shadow-2xl">
            ...
            <p className="text-base sm:text-lg md:text-xl text-center text-gray-800 mb-4 sm:mb-6 italic leading-relaxed">
              I was listening to this song on repeat while coding this entire app for you, Dipti... 🎧💕
            </p>
            ...
            <div className="bg-gradient-to-r from-purple-100 to-pink-100 p-4 sm:p-6 rounded-2xl border-3 border-purple-300 mb-6">
              <p className="text-base sm:text-lg text-center text-purple-900 font-semibold mb-3">
                The Perfect Coding Moment 💻✨
              </p>
              <p className="text-sm sm:text-base text-center text-gray-700 italic leading-relaxed">
                "It was late. The world was quiet. This song played softly in my headphones. And I smiled, because even though you were sleeping peacefully somewhere, I was here... creating magic for you. That empty space in my heart? It's where you live, Dipti." 🌙💕
              </p>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-br from-purple-100 to-pink-100 p-6 sm:p-8 rounded-3xl border-4 border-purple-300 shadow-xl">
            ...
            <div className="space-y-3">
              {[
                { emoji: '🎵', text: 'Uff Meri Dil Mein - on infinite repeat!' },
                { emoji: '💭', text: 'Thinking of your smile while debugging' },
                { emoji: '⌨️', text: 'Typing with love, not just code' },
                { emoji: '🌙', text: 'Working while you dreamed peacefully' },
                { emoji: '💕', text: 'Missing you dherai with every keystroke' },
                { emoji: '✨', text: 'Creating magic just for YOU' }
              ].map((item, i) => (
                <div 
                  key={i}
          ...
          <div className="bg-gradient-to-r from-red-100 to-pink-100 p-6 sm:p-8 rounded-3xl border-4 border-red-300 shadow-xl">
            <p className="text-lg sm:text-xl text-center text-gray-800 leading-relaxed italic">
              "Every song reminds me of you. Every beat syncs with my heartbeat when I think of us. This wasn't just coding - this was composing a love letter in JavaScript, React, and pure emotion." 🎶💻💕
            </p>
            <div className="mt-4 text-center">
              <p className="text-base sm:text-lg font-bold text-pink-700">
                I miss you dherai, Dipti. 💝
              </p>
            </div>
          </div>
        </div>
    ...
    {
      title: "🎮 Mini-Game: Catch My Heart!",
        ...
        <div className="space-y-6">
          <div className="bg-gradient-to-r from-purple-100 to-pink-100 p-8 rounded-3xl border-4 border-purple-300 shadow-2xl">
            ...
            <p className="text-lg text-center text-gray-700 mb-6">
              Before I continue... can you help me catch some hearts? Click them before they float away! 💕
            </p>
            ...
            {countdown === 0 && (
              <div className="mt-6 bg-yellow-100 border-4 border-yellow-400 rounded-2xl p-6">
                <p className="text-3xl font-black text-center text-yellow-900 mb-2">
                  🎉 You caught {caughtHearts} hearts! 🎉
                </p>
                <p className="text-lg text-center text-gray-800 mb-4">
                  {caughtHearts >= 5 ? "Amazing! You're so good at this! 💕" : "That's okay! You caught MY heart, and that's what matters! 😊"}
                </p>
                <button
        ...
        <div className="space-y-6">
          <div className="bg-gradient-to-r from-blue-100 via-indigo-100 to-purple-100 p-6 sm:p-8 rounded-3xl border-4 border-blue-300 shadow-2xl transform hover:scale-105 transition-all duration-500">
            ...
            <div className="bg-white/80 p-4 sm:p-6 rounded-2xl mb-4 border-2 border-blue-200">
              <p className="text-lg sm:text-xl text-center text-gray-800 font-semibold mb-3">
                👨‍⚖️ I'm a lawyer. My domains are policy, projects, and law.
              </p>
              <p className="text-base sm:text-lg text-center text-gray-700 leading-relaxed">
                I spend my days drafting contracts, analyzing legislation, navigating complex legal frameworks... 📚⚖️
              </p>
            </div>
            <div className="bg-gradient-to-r from-pink-100 to-purple-100 p-4 sm:p-6 rounded-2xl border-3 border-pink-300">
              ...
              <p className="text-base sm:text-lg text-center text-gray-800 leading-relaxed mb-4">
                I became a <span className="font-bold text-pink-600">self-made coder</span> just to create this for you! Hehehe 😅
              </p>
              <p className="text-base sm:text-lg text-center text-gray-700 italic leading-relaxed">
                I couldn't ask anyone else to make this. This is MY effort. MY heart coded into every line. MY cutest attempt to show you how much you mean to me. 💝
              </p>
            </div>
          </div>
          ...
          <div className="bg-yellow-50 p-6 sm:p-8 rounded-3xl border-4 border-yellow-300 shadow-xl transform hover:-rotate-1 transition-all">
            <p className="text-lg sm:text-xl md:text-2xl text-center font-bold text-yellow-900 mb-4">
              🌙 I created this while you were sleeping! 
            </p>
            <p className="text-base sm:text-lg text-center text-gray-700 leading-relaxed">
              While you were dreaming peacefully, I was here... learning React, debugging animations, making hearts float... all because making you smile is worth every moment. 💕😊
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="bg-gradient-to-br from-blue-100 to-blue-200 p-4 sm:p-6 rounded-2xl border-3 border-blue-300 transform hover:scale-110 hover:rotate-3 transition-all cursor-pointer" onClick={() => setCollectedHearts(prev => Math.min(prev + 3, 200))}>
              <p className="text-center text-3xl sm:text-4xl mb-2">⚖️</p>
            ...
            <div className="bg-gradient-to-br from-pink-100 to-pink-200 p-4 sm:p-6 rounded-2xl border-3 border-pink-300 transform hover:scale-110 hover:-rotate-3 transition-all cursor-pointer" onClick={() => setCollectedHearts(prev => Math.min(prev + 3, 200))}>
              <p className="text-center text-3xl sm:text-4xl mb-2">💻</p>
          ...
          <div className="bg-gradient-to-r from-purple-100 to-pink-100 p-6 sm:p-8 rounded-3xl border-4 border-purple-300 shadow-xl">
            <p className="text-base sm:text-lg md:text-xl text-center text-gray-800 leading-relaxed italic">
              "How is my scope? From law to love, from contracts to code... I think I'm expanding in the best direction possible - towards YOU." 💝✨
            </p>
          </div>
        </div>
      )
      ...
      content: (
        <div className="space-y-6">
          <div className="bg-gradient-to-r from-yellow-100 to-orange-100 p-6 sm:p-8 rounded-3xl border-4 border-yellow-300 shadow-2xl">
            ...
            <p className="text-base sm:text-lg text-center text-gray-700 mb-6 leading-relaxed">
              If your heart is ready to forgive this silly lawyer who stayed up coding for you... type <span className="font-bold text-pink-600">"{typingChallenge}"</span> below 💕
            </p>
            ...
            {typedText.toLowerCase() === typingChallenge.toLowerCase() && (
              <div className="mt-6 bg-gradient-to-r from-green-100 to-teal-100 border-4 border-green-400 rounded-2xl p-6 sm:p-8 shadow-xl animate-zoomIn">
                <p className="text-4xl sm:text-5xl text-center mb-4">🎊🎉✨💖✨🎉🎊</p>
                ...
                <p className="text-lg sm:text-xl text-center text-gray-800 mb-6 leading-relaxed">
                  Those three words just made my heart skip a beat! Thank you, my beautiful Dipti! 💝
                </p>
                <button
                  onClick={() => {
                    unlockNextPage();
          ...
          <div className="bg-pink-50 p-4 sm:p-6 rounded-3xl border-3 border-pink-200">
            <p className="text-center text-sm sm:text-base text-gray-600 italic leading-relaxed">
              💡 Hint: Three simple words that would make this lawyer-turned-coder the happiest person alive! 😊💕
            </p>
          </div>
        </div>
      )
        ...
        <div className="space-y-6">
          ...
          <div className="bg-gradient-to-r from-red-50 to-pink-50 p-8 rounded-3xl border-4 border-red-200 shadow-xl">
            ...
            <p className="text-xl text-center text-gray-800">
              I miss us. But I'll wait as long as you need. 💕
            </p>
          </div>
        </div>
      )
        ...
        <div className="space-y-6">
          <div className="bg-gradient-to-r from-purple-100 to-pink-100 p-6 sm:p-8 rounded-3xl border-4 border-purple-300 shadow-2xl">
            ...
            <p className="text-lg sm:text-xl text-center text-gray-800 leading-relaxed">
              Thank you for taking this journey with me. Every click, every page, every moment you spent here means the world. 🌍✨
            </p>
          </div>
        </div>
      )
          ...
          <div className="max-w-4xl w-full">
            <div className="mb-6 bg-white/50 backdrop-blur-sm rounded-full p-2 shadow-lg">
              ...
              <p className="text-center text-white font-bold mt-2 text-sm drop-shadow-lg">
                Progress: {currentPage + 1} of {apologyPages.length} | 💕 {collectedHearts}% | 🏆 {miniGameScore}
              </p>
            </div>
